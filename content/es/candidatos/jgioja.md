---
title: "JOSÉ LUIS GIOJA"
date: 2021-02-21T15:08:00-03:00
description: "✔ FRENTE DE TODOS ✔ SAN JUAN"
draft: false
hideToc: false
enableToc: true
...
libraries:
- mermaid
image: https://rest.hcdn.gob.ar/intra/proxy/parlamentaria/fotos/autoridades/20078078201
---

![JOSÉ LUIS GIOJA](https://rest.hcdn.gob.ar/intra/proxy/parlamentaria/fotos/autoridades/20078078201)

##### DATOS PERSONALES
**NOMBRE Y APELLIDO:** <i class="color-rosa">*JOSÉ LUIS GIOJA*</i>
**DISTRITO AL QUE REPRESENTA:** <i class="color-rosa">*SAN JUAN*</i>
**INTERBLOQUE:** <i class="color-rosa">*FRENTE DE TODOS*</i>
**PROFESIÓN:** <i class="color-rosa">*INGENIERO*</i>
**FECHA DE NAC.:** <i class="color-rosa">*04/12/1949*</i>
**PERÍODO:** <i class="color-rosa">*10/12/2019 AL 09/12/2023*</i>
> https://www.hcdn.gob.ar/diputados/jgioja

---
##### DATOS LEGISLATIVOS
###### COMISIONES
- PARLAMENTARIA CONJUNTA ARGENTINO CHILENA (LEY 23172) ```(Presidente titular)```
...
- COMERCIO ```(Vocal)```
- ECONOMIA ```(Vocal)```
- ENERGIA Y COMBUSTIBLES ```(Vocal)```
- OBRAS PUBLICAS ```(Vocal)```
- PRESUPUESTO Y HACIENDA ```(Vocal)```
- TRANSPORTES ```(Vocal)```

> https://www.hcdn.gob.ar/diputados/jgioja/comisiones.html

---
##### PROYECTOS PRESENTADOS

**AUTOR:** <i class="color-rosa">386 Proyectos</i>
**COAUTOR:** <i class="color-rosa">512 Proyectos</i>
> https://www.hcdn.gob.ar/diputados/jgioja/listadodeproy.html
